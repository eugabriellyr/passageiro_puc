package com.minasmob.passageiro.common.fcm;
...
public class MyFireBaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getData() != null) {
            ...
            if(message.equalsIgnoreCase("Promoção")){
    ...
    private void restartPromocao() {
        System.out.println("RRR MyFireBaseMessagingService.restartApp");
        Intent intent = new Intent(this, PromocaoManagerActivity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        startActivity(intent);
    ...
    private void sendNotificationProlonged(String messageBody) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            AudioAttributes attributes = new AudioAttributes.Builder()
                    ...
                    .build();
            NotificationManager notificationManager = (NotificationManager) getSystemService(Context.NOTIFICATION_SERVICE);
            NotificationChannel channel = new NotificationChannel(channelId, "Sos", NotificationManager.IMPORTANCE_HIGH);
            channel.setLockscreenVisibility(Notification.VISIBILITY_PUBLIC);
            channel.setDescription(messageBody);
            channel.enableLights(true);
            channel.setLightColor(Color.RED);
