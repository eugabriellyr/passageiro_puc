...
import com.minasmob.passageiro.ui.educacao_saude.EducacaoSaudeActivity;
...
public class Educacao_SaudeActivity extends BaseActivity  {
    ...
    public int getLayoutId() {
        return R.layout.activity_educacao_saude;
    }
    ...
    @OnClick({ R.id.proximo})
    public void onViewClicked(View view) {
        switch (view.getId()) {

            case R.id.proximo:
                startActivity(new Intent(this, EducacaoSaudeActivity.class));
