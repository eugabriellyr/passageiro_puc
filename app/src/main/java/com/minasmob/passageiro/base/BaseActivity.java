...
import com.minasmob.passageiro.common.CustomDialog;
import com.minasmob.passageiro.common.LocaleHelper;
import com.minasmob.passageiro.data.SharedHelper;
import com.minasmob.passageiro.ui.activity.OnBoardActivity;
import com.minasmob.passageiro.ui.activity.login.EmailActivity;
import com.minasmob.passageiro.ui.activity.login.PasswordActivity;
...
public abstract class BaseActivity extends AppCompatActivity
    ...
    protected LatLng mDefaultLocation = new LatLng( -23.46202330, -46.65101000 );
    ...
    private void checkConnection() {
        ...
        if (activity instanceof SplashActivity || activity instanceof EmailActivity ||
                activity instanceof PasswordActivity ||
            ...
            if (e instanceof ConnectException || e instanceof UnknownHostException ||
                ...
                try {
                    ...
                    if (responseCode == 400 || responseCode == 405)
                        Toast.makeText( this, getErrorMessage( jsonObject, getString( R.string.something_went_wrong ) ), Toast.LENGTH_SHORT ).show();
                        ...
                        Toasty.info( this, getErrorMessage( jsonObject, getString( R.string.invalid_input ) ), Toast.LENGTH_LONG ).show();
