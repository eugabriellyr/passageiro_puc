...
public class EducacaoSaudePresenter<V extends EducacaoSaudeIView> extends BasePresenter<V> implements EducacaoSaudeIPresenter<V> {

    @Override
    public void update(HashMap<String, RequestBody> obj, @Part MultipartBody.Part filename) {
        getCompositeDisposable().add(APIClient
                .getAPIClient()
                .editEducador(obj, filename)
