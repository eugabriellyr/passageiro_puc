...
public class Payment {
    ...
    @SerializedName("desc_estudante")
    @Expose
    private double desc_estudante;

    @SerializedName("porta_malas")
    @Expose
    ...
    public double getDesc() {
        return desc_estudante;
    }

    public void setDesc(double desc_estudante) {
        this.desc_estudante = desc_estudante;
    }

    public double getPortaM() {
        return porta_malas;
    }

    public void setPortaM(double porta_malas) {
