...
public class Provider {
    ...
    @SerializedName("link_picpay")
    @Expose
    public String link_picpay;
    @SerializedName("chave_pix")
    @Expose
    public String chave_pix;

    @SerializedName("link_mp")
    @Expose
    public String link_mp;
    ...
    public void setLinkPicpay(String link_picpay) {
        this.link_picpay = link_picpay;
    }

    public String getLinkPicpay() {
        return link_picpay;
    }
    public void setChavePix(String chave_pix) {
    ...
    public void setLinkMp(String link_picpay) {
