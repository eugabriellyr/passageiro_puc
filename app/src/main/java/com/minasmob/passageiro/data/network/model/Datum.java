...
public class Datum implements Serializable {
    ...
    public String getTaxa_l() {
        return taxa_liga;
    }

    public void setTaxa_l(String taxa_liga) {
    ...
    public void setTempoinicio(int tempo_inicio) {
    ...
    public void setTempofinal(int tempo_final) {
        this.tempo_final = tempo_final;
    }
    ...
    public String getDataFinal() {
        ...
        public void setData_final(String aceita) {
            this.aceita = aceita;
        }
