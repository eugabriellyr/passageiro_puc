...
import com.minasmob.passageiro.data.network.model.Rating;
import com.minasmob.passageiro.ui.fragment.InvoiceDialogFragment;
import com.minasmob.passageiro.ui.fragment.dispute.DisputeCallBack;
import com.minasmob.passageiro.ui.fragment.dispute.DisputeFragment;
import com.minasmob.passageiro.ui.fragment.dispute_status.DisputeStatusFragment;
import com.minasmob.passageiro.ui.fragment.lost_item.LostFragment;
import com.minasmob.passageiro.ui.fragment.lost_item_status.LostItemStatusFragment;
        ...
        if (datum != null) {
            ...
            try {
               ...
               /* int t_a = datum.getTempo_inicio();
                ...
                finishedAt.setText( datum.getData_Final());
                duracao.setText(String.valueOf(datum.getTravelTime()+" minutos") );
                started.setText(datum.getDataInicio());
                finishedAtTime.setText(String.valueOf(time));
                id_m.setText(String.valueOf("ID " +datum.getProvider().getId()));
